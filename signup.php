...
<div id="signup_success"></div><!--hiển thị sau khi đăng kí thành công-->
                    ...
                    success : function (result)
                    {
                        ...
                        if (html != ''){
                            ...
                            $('#signup').html('');
                             ...
                             $('#signup_success').html("<div id='fade' class='col-md-12'><div class='alert alert-success'> <span class='glyphicon glyphicon-ok'></span> Xin chúc mừng bạn đã tạo tài khoản thành công </div></div>");
                        }
                    }
                });
