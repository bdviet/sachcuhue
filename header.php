<head>
<link rel="shortcut icon" href="http://localhost/sachcuhue/img/favicon.png" type="image/x-icon" />
    <meta charset="utf-8">
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <!-- Bootstrap Core CSS -->
    <link href="http://localhost/sachcuhue/css/bootstrap.min.css" rel="stylesheet">
    <link href="http://localhost/sachcuhue/css/login.css" rel="stylesheet">
    <link href="http://localhost/sachcuhue/css/shop-homepage.css" rel="stylesheet">
    <!-- Custom CSS -->
