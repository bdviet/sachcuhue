...
include('../connect.php');
$id_member = $_GET['id'];
$sql = "SELECT *, id FROM postads WHERE id='$id_member'";
                  ...
                  <legend class='text-center active'>  <label>Cập nhật thông tin</label></legend>
                    <fieldset>
                        ...
                        <div class='form-group col-md-12'>
                            ...
                            <div class='input-group'>
                            <input value='{$data['contact']}' data-error='Vui lòng nhập thông tin liên hệ' type='text'  class='form-control' name='contact' id='contact' placeholder='Thông tin liên hệ' disabled>     
                            </div>
                             <div class='help-block with-errors'></div>
                        </div>
                        ...
                        <button style='margin:auto; display:block;' id='change' type='button' class='btn btn-primary'>
                                Cập nhật
                        </button>   
</div>
</div>
...
?>
     ...
     <script language="javascript">
        $('#change').click(function () {
            ...
            if ($.trim(title) == ''||$.trim(content) == ''||$.trim(price) == ''||$.trim(contact) == ''){
                $('#errorinput').html('');
